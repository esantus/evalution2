...
def classify(train, dev, test, clfs=['random_forest', 'logistic_regression', 'feed_forward_nn'], combinations=['concat', 'sum', 'mult'], emb_path='../embeddings/glove.6B.300d.txt', emb_dims=300):
